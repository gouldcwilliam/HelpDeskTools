...
namespace ExtractEmployeeTables
{
	public static class Functions
	{
		...
		public static bool CopyEmpExtract(string computer)
		{
			try
			{
				File.Copy(string.Format(@"\\{0}\c$\temp\emp_extract.txt",computer), string.Format(@"C:\temp\emp_extract\{0}.log", computer), true);
				return true;
			}
